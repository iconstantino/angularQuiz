...
(function(){
    angular
        ...
        var quizQuestions = [
            {
                type: 'text',
                text: 'Which of these is the youngest member of the Manchester squad?',
                possibilities: [
                    {
                        answer: 'Wayne Rooney'
                    },
         ...
         var playersData = [
            ...
            },
            {
                ...
                bio: 'Henrikh Mkhitaryan is not your average footballer. The man from Armenia, his country\'s captain and finest player, speaks six languages and is keen to embrace an academic future in retirement.',
